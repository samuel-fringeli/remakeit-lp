...
const Footer = () => {
	...
	return (
		<div className="relative mx-auto text-white flex flex-col items-center justify-center gap-8 py-24 bg-primary">
			<div className="font-semibold text-2xl">{t('Create your next viral video')}</div>
			...
			<div className="bg-white w-full container rounded-[64px] py-10 px-24 space-y-4 text-primary">
